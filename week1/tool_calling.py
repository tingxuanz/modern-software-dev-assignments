...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = """
You are a tool-calling assistant. You have access to the following tool:
...
Parameters:
  - file_path (string, optional): Path to the Python file to analyze. Defaults to the current file if omitted.

When the user asks you to call a tool, respond with ONLY a JSON object in this exact format (no extra text, no markdown):
